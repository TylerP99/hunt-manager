...
const linkStyles = "w-fit flex items-center space-x-2 p-1 hover:text-lightBlue";
    ...
    <header className={headerContainerStyles}>
        <nav className="relative container mx-auto p-6">
          ...
          <div className="md:hidden">
              <div id="menu" className={"absolute flex flex-col items-center self-end py-8 mt-10 space-y-6 font-bold bg-white sm:w-auto sm:self-center left-6 right-6 drop-shadow-md" + (navOpen ? "" : " hidden") }>
                {signedIn ? 
                  (
                    <Link className={linkStyles} to="/logout">
                      <FaSignOutAlt className="align-baseline" /> <p>Log out</p>
